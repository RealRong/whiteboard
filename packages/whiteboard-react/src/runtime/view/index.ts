...
import { isScopeViewEqual, readScopeView } from '../../view/container'
import { contextMenuStateAtom } from '../../../ui/chrome/context-menu/domain'
import { isInteractionViewEqual, readInteractionView } from '../../view/interaction'
import { isSelectionStateEqual, readSelectionState } from '../../view/selection'
